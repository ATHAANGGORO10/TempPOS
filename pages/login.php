...
<body class="bg-gradient-primary">
  ...
  <div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="card" style="width: 100%; max-width: 500px;">
      <div>
        <img class="card-img-top img-fluid" style="height: 200px; object-fit: cover;" src="../assets/img/about.png">
      </div>
      <div class="card-body">
        ...
        <form class="user px-3" method="POST">
          <div class="form-group">
            <input class="form-control form-control-user" type="text" id="exampleInputEmail" placeholder="Username"
              name="username">
          </div>
          <div class="form-group">
